...
# Generated: Sat Apr 22 18:57:53 2017
##################################################
...
class satnogs_fm_demod(gr.top_block):
    ...
    def __init__(self, cw_offset=1500, doppler_correction_per_sec=1000, file_path='test.wav', lo_offset=100e3, ppm=0, rigctl_port=4532, rx_freq=100e6, rx_sdr_device='usrpb200', waterfall_file_path='/tmp/waterfall.dat'):
        gr.top_block.__init__(self, "USB Generic Demodulation")
