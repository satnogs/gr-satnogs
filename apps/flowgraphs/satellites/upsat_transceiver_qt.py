...
# Generated: Sat Feb  4 21:55:55 2017
##################################################
...
class upsat_transceiver_qt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, recv_port=16886, send_port=5022, wod_port=5023, lo_offset=100e3, bind_addr='0.0.0.0', rx_sdr_device='usrpb200', dest_addr='127.0.0.1', tx_sdr_device='usrpb200'):
...
def main(top_block_cls=upsat_transceiver_qt, options=None):
    ...
    tb = top_block_cls(recv_port=options.recv_port, send_port=options.send_port, wod_port=options.wod_port, lo_offset=options.lo_offset, bind_addr=options.bind_addr, rx_sdr_device=options.rx_sdr_device, dest_addr=options.dest_addr, tx_sdr_device=options.tx_sdr_device)
    tb.start()
    tb.show()
